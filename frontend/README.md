...
Dataset upload/preview/management, backtest configuration and execution,
history, the result dashboard, charts, comparison, export download buttons,
optimization, and in-browser PDF rendering. There is no end-to-end browser
suite beyond the authentication flow, and no deployment or Docker setup.
